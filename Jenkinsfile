pipeline {
	...
	environment {		
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/attiny1617-core-independent-night-light-using-ccl-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/attiny1617-core-independent-night-light-using-ccl-studio.git'
