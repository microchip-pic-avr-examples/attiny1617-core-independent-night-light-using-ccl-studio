 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void Button_1_set_pull_mode(const enum port_pull_mode pull_mode)
{
 ...
 *                      (low power state)
 */
static inline void Button_1_set_dir(const enum port_dir dir)
{
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void Button_1_set_isc(const PORT_ISC_t isc)
{
 ...
 */
static inline void Button_1_set_inverted(const bool inverted)
{
 ...
 *                  false = Pin level set to "low" state
 */
static inline void Button_1_set_level(const bool level)
{
 ...
 * Toggle the pin level
 */
static inline void Button_1_toggle_level()
{
 ...
 * Reads the level on a pin
 */
static inline bool Button_1_get_level()
{
 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void Button_2_set_pull_mode(const enum port_pull_mode pull_mode)
{
 ...
 *                      (low power state)
 */
static inline void Button_2_set_dir(const enum port_dir dir)
{
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void Button_2_set_isc(const PORT_ISC_t isc)
{
 ...
 */
static inline void Button_2_set_inverted(const bool inverted)
{
 ...
 *                  false = Pin level set to "low" state
 */
static inline void Button_2_set_level(const bool level)
{
 ...
 * Toggle the pin level
 */
static inline void Button_2_toggle_level()
{
 ...
 * Reads the level on a pin
 */
static inline bool Button_2_get_level()
{
 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void PIR_input_set_pull_mode(const enum port_pull_mode pull_mode)
{
 ...
 *                      (low power state)
 */
static inline void PIR_input_set_dir(const enum port_dir dir)
{
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void PIR_input_set_isc(const PORT_ISC_t isc)
{
 ...
 */
static inline void PIR_input_set_inverted(const bool inverted)
{
 ...
 *                  false = Pin level set to "low" state
 */
static inline void PIR_input_set_level(const bool level)
{
 ...
 * Toggle the pin level
 */
static inline void PIR_input_toggle_level()
{
 ...
 * Reads the level on a pin
 */
static inline bool PIR_input_get_level()
{
